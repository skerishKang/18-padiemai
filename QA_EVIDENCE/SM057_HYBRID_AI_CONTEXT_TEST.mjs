...
const root = path.resolve('/mnt/data/sm057_work/StoryMemory_CloudflarePreview_v3.3.4');
...
fs.writeFileSync(path.join(root,'QA_EVIDENCE/SM057_HYBRID_AI_CONTEXT_RESULT.json'),JSON.stringify(result,null,2)+'\n');
