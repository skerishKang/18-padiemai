...
const COPY = {
ko: {
metaTitle: "PADIEM — AI로 일을 다시 설계합니다",
metaDescription: "PADIEM — AI로 산업과 공공, 콘텐츠의 일을 다시 설계하는 기술기업",
navCta: "프로젝트 상담",
...
focusCopy: "교육에서 끝나는 AI가 아니라, 조직의 데이터를 이해하고 업무에 들어가며 결과를 검증할 수 있는 시스템을 만듭니다.",
contactTitle: "당신의 일을<br/>AI와 함께 다시 설계합니다.",
contactPrimary: "프로젝트 문의",
contactSecondary: "처음으로",
emailLabel: "문의 이메일",
closeLabel: "닫기",
panels: {
ax: { accent:"143,207,255", kicker:"SOLUTIONS 01", title:"Generative AI · AX", lead:"기업의 문서, 지식, 보고, 견적, 교육과 반복 업무를 AI 기반으로 다시 설계합니다.", items:["기업용 AI 에이전트","업무 프로세스 자동화","사내 문서와 지식 검색","보고서·제안서·견적서 생성","조직 맞춤형 AI 시스템","도입 전략과 운영 체계 설계"] },
public: { accent:"126,221,230", kicker:"SOLUTIONS 02", title:"Public AI Agent", lead:"복잡한 정책과 행정 절차를 시민이 이해하고 실행할 수 있는 언어로 연결합니다.", items:["지자체 AI 안내 서비스","행정정보와 정책 탐색","민원·신청서 작성 지원","공공데이터 연결","다국어 행정 안내","국민 체감형 AI 서비스"] },
multimodal: { accent:"239,196,123", kicker:"SOLUTIONS 03", title:"Multimodal Content AI", lead:"텍스트, 음성, 이미지와 영상을 하나의 콘텐츠 제작 흐름으로 연결합니다.", items:["음성인식","음성합성","실시간 통역·번역","이미지·영상 생성","다국어 콘텐츠 제작","립싱크와 음성 기반 영상","자동 요약과 콘텐츠 재구성"] },
...
focusCopy: "We build systems that understand organizational data, enter real workflows, and produce verifiable results—not AI that ends with training alone.",
contactTitle: "Redesign Your Work<br/>Together with AI.",
contactPrimary: "Start a Project",
contactSecondary: "Back to Top",
emailLabel: "Contact Email",
closeLabel: "Close",
panels: {
ax: { accent:"143,207,255", kicker:"SOLUTIONS 01", title:"Generative AI · AX", lead:"We redesign documents, knowledge, reporting, estimates, training, and repetitive work through enterprise AI.", items:["Enterprise AI Agents","Workflow Automation","Internal Knowledge Search","Report, Proposal, and Estimate Generation","Organization-Specific AI Systems","AI Adoption and Operating Models"] },
public: { accent:"126,221,230", kicker:"SOLUTIONS 02", title:"Public AI Agent", lead:"We translate complex policies and administrative procedures into language citizens can understand and act on.", items:["Municipal AI Guidance","Policy and Administrative Search","Civil Petition and Application Support","Public Data Integration","Multilingual Administrative Guidance","Citizen-Centered AI Services"] },
multimodal: { accent:"239,196,123", kicker:"SOLUTIONS 03", title:"Multimodal Content AI", lead:"We connect text, speech, images, and video into one integrated content workflow.", items:["Speech Recognition","Text-to-Speech","Real-Time Interpretation and Translation","Image and Video Generation","Multilingual Content Production","Lip Sync and Voice-Driven Video","Automated Summarization and Repurposing"] },
